<template>
    <UModal v-model:open="isOpen">
        ...
        <template #body>
            <UForm :state="stateForm" :schema="schema" ref="form" @submit.prevent="save">
                ...
                <UFormField label="Transaction date" name="created_at" required="true">
                    <UInput v-model="stateForm.created_at" type="date" icon="i-heroicons-calendar-days-20-solid">
                    </UInput>
                </UFormField>
                <UFormField label="Description" hint="Optional" name="description">
                    <UTextarea v-model.trim="stateForm.description"></UTextarea>
                </UFormField>
                <UFormField label="Category" required name="category" v-if="stateForm.type === 'Expense'">
